					...
					<div class="detail-card">
						...
						<div class="detail-grid">
							<div class="detail-row">
								<span class="detail-label">Expense Name</span>
								<span class="detail-value">{{ $expense->e_name ?? 'Not specified' }}</span>
							</div>
							<div class="detail-row">
								<span class="detail-label">Entry Date</span>
								<span class="detail-value">
									{{ $expense->entry_date ? \Carbon\Carbon::parse($expense->entry_date)->format('d-m-Y') : \Carbon\Carbon::parse($expense->created_at)->format('d-m-Y') }}
								</span>
							</div>
							<div class="detail-row">
								<span class="detail-label">Created At</span>
								<span class="detail-value">{{ $expense->created_at->format('d-m-Y H:i:s') }}</span>
							</div>
							<div class="detail-row">
								<span class="detail-label">Last Updated</span>
								<span class="detail-value">{{ $expense->updated_at->format('d-m-Y H:i:s') }}</span>
							</div>
						</div>
					</div>
					...
					<div class="detail-card">
						...
						<div class="detail-grid">
							<div class="detail-row">
								...
								<span class="detail-value amount-value">₹{{ number_format($expense->amount, 2) }}</span>
							</div>
							<div class="detail-row">
								<span class="detail-label">Payment Method</span>
								<span class="detail-value">{{ $expense->payment_method ?? 'Not specified' }}</span>
							</div>
						</div>
					</div>
					...
					<div class="detail-card">
						...
						<div class="detail-grid">
							...
							<div class="detail-row">
								...
								<span class="detail-value">{{ $expense->subcategory ?? 'Not applicable' }}</span>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-4">
					...
					<div class="detail-card">
						...
						<div class="d-grid gap-2">
							<a href="{{ route('expense.edit', $expense) }}" class="btn btn-warning btn-lg">
								<span class="svg-icon svg-icon-2 me-2">
							...
							<button type="button" class="btn btn-danger btn-lg" onclick="deleteExpense({{ $expense->id }})">
								<span class="svg-icon svg-icon-2 me-2">
									<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 16 16" fill="currentColor">
