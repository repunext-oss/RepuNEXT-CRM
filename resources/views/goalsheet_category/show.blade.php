				...
				<div class="card-body border-0 pt-0">  
					<div class="row">
						<div class="col-lg-6 fv-row">
							...
							<input type="text" name="gc_name" id="gc_name" value="{{$repn->gc_name}}" readonly placeholder="Goal Task Name" required class="form-control form-control-lg form-control-solid mb-3 mb-lg-0 "/>
						</div>       
				</div>
				<div class="card-footer d-flex justify-content-end py-6 px-9" >
					<a href="{{route('list.gscategory')}}" class="btn btn-primary"> Back </a>
				</div> 
			</div>
		</div>
	</div>
