				...
				<div class="card-body border-0 pt-0">
					...
					@csrf	
						<div class="row">
							<div class="col-lg-6 fv-row">
								...
								<input type="text" name="Name" value="{{ $intern->Name }}" class="form-control" disabled />
							</div>
							<div class="col-lg-6 fv-row">
								<label class="fw-bold fs-6">Phone Number</label>
								<input type="text" name="Mobile" value="{{ $intern->Mobile }}" class="form-control" required minlength="10" maxlength="10"disabled />
							</div>
						</div>

						<div class="row mt-3">
							<div class="col-lg-3 fv-row">
								<label class="fw-bold fs-6"disabled>Start Date</label>
								<input type="date" name="Startdate" value="{{ $intern->Startdate }}" class="form-control"disabled />
							</div>
							<div class="col-lg-3 fv-row">
								<label class="fw-bold fs-6">End Date</label>
								<input type="date" name="Enddate" value="{{ $intern->Enddate }}" class="form-control" disabled/>
							</div>
							<div class="col-lg-3 fv-row">
								<label class="fw-bold fs-6">Duration</label>
								<select name="Duration" class="form-control" disabled>
									<option value="" disabled selected>Choose Duration</option>
									@foreach(['7','10','15','30','60','90','180'] as $value)
										<option value="{{ $value }}" {{ $intern->Duration == $value ? 'selected' : '' }}>{{ $value }} Days</option>
									@endforeach
								</select>
							</div>
							<div class="col-lg-3 fv-row">
								<label class="fw-bold fs-6">Slot</label>
								<select name="Slot" class="form-control" disabled>
									@foreach(['Slot1','Slot2','Slot3','Slot4','Slot5','Slot6'] as $value)
										<option value="{{ $value }}" {{ $intern->Slot == $value ? 'selected' : '' }}>{{ $value }}</option>
									@endforeach
								</select>
							</div>
						</div>
						...
						<div class="row">
							<div class="col-lg-8 fv-row">
								...
								<select class="form-control form-control-lg form-control mb-3 mb-lg-0" name="Course" disabled>
									<option value="" disabled {{ $intern->Course == '' ? 'selected' : '' }}>Choose Course</option>
									<option value="Web Development" {{ $intern->Course == 'Web Development' ? 'selected' : '' }}>Web Development</option>
									<option value="Software Development" {{ $intern->Course == 'Software Development' ? 'selected' : '' }}>Software Development</option>
									<option value="Web Application" {{ $intern->Course == 'Web Application' ? 'selected' : '' }}>Web Application</option>
									<option value="Full Stack" {{ $intern->Course == 'Full Stack' ? 'selected' : '' }}>Full Stack</option>
									<option value="UI UX Design" {{ $intern->Course == 'UI UX Design' ? 'selected' : '' }}>UI UX Design</option>
									<option value="HR & Admin" {{ $intern->Course == 'HR & Admin' ? 'selected' : '' }}>HR & Admin</option>
									<option value="Finance & Accounting" {{ $intern->Course == 'Finance & Accounting' ? 'selected' : '' }}>Finance & Accounting</option>
									<option value="Prompt Engineering" {{ $intern->Course == 'Prompt Engineering' ? 'selected' : '' }}>Prompt Engineering</option>
									<option value="Soft skills" {{ $intern->Course == 'Soft skills' ? 'selected' : '' }}>Soft skills</option>
									<option value="SEO" {{ $intern->Course == 'SEO' ? 'selected' : '' }}>SEO</option>
									<option value="Graphic Design" {{ $intern->Course == 'Graphic Design' ? 'selected' : '' }}>Graphic Design</option>
									<option value="Photography" {{ $intern->Course == 'Photography' ? 'selected' : '' }}>Photography</option>
									<option value="Video Editing" {{ $intern->Course == 'Video Editing' ? 'selected' : '' }}>Video Editing</option>
									<option value="Animation" {{ $intern->Course == 'Animation' ? 'selected' : '' }}>Animation</option>
									<option value="Social Media" {{ $intern->Course == 'Social Media' ? 'selected' : '' }}>Social Media</option>
									<option value="Digital Marketing" {{ $intern->Course == 'Digital Marketing' ? 'selected' : '' }}>Digital Marketing</option>
									<option value="Entrepreneurship" {{ $intern->Course == 'Entrepreneurship' ? 'selected' : '' }}>Entrepreneurship</option>
									<option value="Content Writer" {{ $intern->Course == 'Content Writer' ? 'selected' : '' }}>Content Writer</option>
									<option value="Branding" {{ $intern->Course == 'Branding' ? 'selected' : '' }}>Branding</option>
								</select>
							</div>

							<div class="col-lg-4 fv-row">
								<label class="fw-bold fs-6 mb-2">Source</label>
								<select class="form-control form-control-lg form-control mb-3 mb-lg-0" name="Source" disabled>
									<option value="" disabled {{ $intern->Source == '' ? 'selected' : '' }}>Choose Source</option>
									<option value="Reference" {{ $intern->Source == 'Reference' ? 'selected' : '' }}>Reference</option>
									<option value="Facebook Ads" {{ $intern->Source == 'Facebook Ads' ? 'selected' : '' }}>Facebook Ads</option>
									<option value="Google Ads" {{ $intern->Source == 'Google Ads' ? 'selected' : '' }}>Google Ads</option>
									<option value="Flute board" {{ $intern->Source == 'Flute board' ? 'selected' : '' }}>Flute board</option>
									<option value="Chatgpt" {{ $intern->Source == 'Chatgpt' ? 'selected' : '' }}>Chatgpt</option>
									<option value="Google" {{ $intern->Source == 'Google' ? 'selected' : '' }}>Google</option>
									<option value="Map" {{ $intern->Source == 'Map' ? 'selected' : '' }}>Map</option>
									<option value="Other" {{ $intern->Source == 'Other' ? 'selected' : '' }}>Other</option>
								</select>
							</div>
						</div>
						...
						<div class="row mt-3">
							...
							<div class="col-lg-4 fv-row">
								...
								<select name="{{ $field }}" class="form-control"disabled>
									<option value="Yes" {{ $intern->$field == 'Yes' ? 'selected' : '' }}>Yes</option>
									<option value="No" {{ $intern->$field == 'No' ? 'selected' : '' }}>No</option>
								</select>
							</div>
							@endforeach
						</div>
					...
					<div class="row mt-3">
							<div class="col-lg-4 fv-row">
								...
								<input type="text" name="Collage" value="{{ $intern->Collage }}" class="form-control" disabled />
							</div>
							<div class="col-lg-4 fv-row">
						...
						<div class="row mt-3">
							...
							<div class="col-lg-4 fv-row">
								...
								<input type="text" name="Area" value="{{ $intern->Area }}" class="form-control" disabled />
							</div>
							<div class="col-lg-4 fv-row">
								<label class="fw-bold fs-6">City</label>
								<input type="text" name="City" value="{{ $intern->City }}" class="form-control" disabled />
							</div>
						</div>
						<div class="row mt-3">
							<div class="col-lg-6 fv-row">
								<label class="fw-bold fs-6">Amount</label>
								<input type="text" name="Amount" value="{{ $intern->Amount }}" class="form-control" disabled />
							</div>
							<div class="col-lg-6 fv-row">
								<label class="fw-bold fs-6">Status</label>
								<select name="amt" class="form-control"disabled>
						...
						<div class="card-footer d-flex justify-content-end py-6 px-9 mt-4">
							<a href="{{ route('list.intern') }}" class="btn btn-light-success me-2">Back</a>
