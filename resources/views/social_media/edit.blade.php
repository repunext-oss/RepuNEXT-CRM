            ...
            <div class="card"> 
                <div class="card-header pt-5">
                    <h3 class="card-title align-items-start flex-column">
                        <span class="card-label fw-bold fs-3 mb-1">Edit Social Media</span>
                        <span class="text-muted fw-semibold fs-7">
                            <a href="{{ route('dashboard') }}" class="text-muted text-hover-primary">Home</a> / Social Media
                        </span>
                    </h3> 
                </div>
                <form action="{{ route('update.smedia') }}" method="POST" class="form" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="row">
                            <div class="col-lg-4 fv-row">
                                ...
                                <input type="text" name="sm_company" id="sm_company" 
                                    value="{{ $repn->sm_company }}" placeholder="Company Name" 
                            ...
                            <div class="col-lg-4 fv-row">
                                ...
                                <input type="text" name="sm_name" id="sm_name" 
                                    value="{{ $repn->sm_name }}" placeholder="Social Media  Name" 
                                    required class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"/>
                            </div>
							<div class="col-lg-4 fv-row">
