			...
			<div class="card "> 
				<div class="card-header pt-5">
					<h3 class="card-title align-items-start flex-column">
						<span class="card-label fw-bold fs-3 mb-1">Edit SubDomain Details</span>
						<span class="text-muted fw-semibold fs-7"><a href="{{route('dashboard')}}" class="text-muted text-hover-primary">Home</a> / Domain / SubDomain </span>
					</h3> 
				</div>
				<form action="{{ route('update.sddetail') }}" method="post" class="form" enctype="multipart/form-data">
				@csrf
