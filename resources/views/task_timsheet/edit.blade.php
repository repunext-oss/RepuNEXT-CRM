	...
	<div class="post d-flex flex-column-fluid" id="kt_post">
		<div class="container-xxl" id="kt_content_container">
			<div class="card "> 
				...
				<form action="{{ route('update.ttimecat') }}" method="post" class="form" enctype="multipart/form-data">
				@csrf
					...
					<div class="row">
							...
							<input type="text" name="id" value="{{ $repn->id }}" hidden>
								...
								<select name="tt_cat[]"  id="tt_cat" class="form-select mb-3 form-control"  data-control="select2" data-placeholder="Select an option" data-allow-clear="true" multiple="multiple" >
							...
							<input type="text" name="id" value="{{ $repn->id }}" hidden>
								...
								<input type="text" name="tt_name" id="tt_name" value="{{ $repn->tt_name }}" required class="form-control form-control-lg form-control-solid mb-3 mb-lg-0 "/>
							</div> 
					</div>   
					<br>
					...
					<div class="row">
							...
							<textarea name="tt_desc" id="tt_desc" required class="form-control form-control-lg form-control-solid mb-3 mb-lg-0">{{ $repn->tt_desc }}</textarea>
						</div>
					</div>
					<br> 
						...
						<div class="row">
							...
							<input type="text" name="id" value="{{ $repn->id }}" hidden>
								...
								<input type="time" name="tt_starttime" id="tt_starttime" value="{{ $repn->tt_starttime }}" required class="form-control form-control-lg form-control-solid mb-3 mb-lg-0 "/>
							</div> 
							<div class="col-lg-6 fv-row">
								<label class="col-lg-12 col-form-label required fw-bold fs-6">Task EndTime</label>
								<input type="time" name="tt_endtime" id="tt_endtime" value="{{ $repn->tt_endtime }}" required class="form-control form-control-lg form-control-solid mb-3 mb-lg-0 "/>
							</div>  
						</div>   
						<br> 
