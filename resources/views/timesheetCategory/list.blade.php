			...
			<div class="card "> 
				<div class="card-header pt-5">
					...
					<div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
						@if(in_array("timesheet_category_all",$rolerawdata, TRUE) || in_array("timesheet_category_create",$rolerawdata, TRUE)|| in_array("kt_roles_select_all",$rolerawdata, TRUE))
							<a href="{{ route('add.timecat') }}"><button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_user" >
				...
				<div class="card-body pt-0"> 
					<table class="table border align-middle rounded  dataTable table-row-dashed fs-6 gy-5" id="kt_ecommerce_report_views_table">
						...
						<tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase text-muted bg-light">
							...
							<th >#</th>
							<th class="min-w-125px sorting">TimesheetCategory Name</th> 
							<th class="min-w-125px sorting">Timesheet Designation Category </th> 
						...
						<tbody class="fw-semibold text-gray-600">
							...
							<tr>
								...
								<td >{{ $repns->tc_name }}</td> 
								<td >{{ $repns->tc_designation_category }}</td> 
								...
								<td>
									@if(in_array("timesheet_category_all",$rolerawdata, TRUE) || in_array("timesheet_category_read",$rolerawdata, TRUE)||in_array("kt_roles_select_all",$rolerawdata, TRUE))
									<a href="{{route('view.timecat', $repns->id)}}" class="btn btn-sm btn-warning align-self-center" style="border-radius: 100px;padding: 8px 8px 8px 10px;">
										<i class="fa fa-eye" aria-hidden="true"></i>
									</a> 
									@endif
									@if(in_array("timesheet_category_all",$rolerawdata, TRUE) || in_array("timesheet_category_write",$rolerawdata, TRUE)||in_array("kt_roles_select_all",$rolerawdata, TRUE))      
									<a href="{{route('edit.timecat', $repns->id)}}" class="btn btn-sm btn-info align-self-center" style="border-radius: 104px;padding: 8px 8px 10px 13px;margin: 0px 1px;">
										<i class="fa fa-edit" aria-hidden="true"></i>
									</a>
									@endif
									@if(in_array("timesheet_category_all",$rolerawdata, TRUE) || in_array("timesheet_category_delete",$rolerawdata, TRUE)||in_array("kt_roles_select_all",$rolerawdata, TRUE))
