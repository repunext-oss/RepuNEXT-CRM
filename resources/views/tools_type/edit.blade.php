			...
			<div class="card "> 
				<div class="card-header pt-5">
					<h3 class="card-title align-items-start flex-column">
						<span class="card-label fw-bold fs-3 mb-1">Edit Tools Type</span>
				...
				@csrf
					...
					<div class="row">
							...
							<input type="text" name="id" value="{{ $repn->id }}" hidden>   
								...
								<input type="text" name="tooltype_name" id="tooltype_name" value="{{$repn->tooltype_name}}" placeholder="toolstype name" required class="form-control form-control-lg form-control-solid mb-3 mb-lg-0 "/>
							</div>  
