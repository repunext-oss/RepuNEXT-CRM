			...
			<div class="card "> 
				<div class="card-header pt-5">
					<h3 class="card-title align-items-start flex-column">
						<span class="card-label fw-bold fs-3 mb-1">List Tools Type</span>
					...
					<div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
							@if(in_array("tool_all",$rolerawdata, TRUE) || in_array("tool_create",$rolerawdata, TRUE)|| in_array("kt_roles_select_all",$rolerawdata, TRUE))
							<a href="{{ route('add.tooltime') }}"><button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_user" >
					...
					<table class="table border align-middle rounded  dataTable table-row-dashed fs-6 gy-5" id="kt_ecommerce_report_views_table">
						...
						<tbody class="fw-semibold text-gray-600">
							...
							<tr>
								...
								<td>
									@if(in_array("tool_all",$rolerawdata, TRUE) || in_array("tool_read",$rolerawdata, TRUE) || in_array("kt_roles_select_all",$rolerawdata, TRUE))
									<a href="{{route('view.tooltime', $repns->id)}}" class="btn btn-sm btn-warning align-self-center" style="border-radius: 100px;padding: 8px 8px 8px 10px;">
										<i class="fa fa-eye" aria-hidden="true"></i>
									</a> 
									@endif
									@if(in_array("tool_all",$rolerawdata, TRUE) || in_array("tool_write",$rolerawdata, TRUE)||in_array("kt_roles_select_all",$rolerawdata, TRUE))             
									<a href="{{route('edit.tooltime', $repns->id)}}" class="btn btn-sm btn-info align-self-center" style="border-radius: 104px;padding: 8px 8px 10px 13px;margin: 0px 1px;">
										<i class="fa fa-edit" aria-hidden="true"></i>
									</a>
									@endif
									@if(in_array("tool_all",$rolerawdata, TRUE) || in_array("tool_delete",$rolerawdata, TRUE)||in_array("kt_roles_select_all",$rolerawdata, TRUE))
...
<script>  
	...
	function Check(value,id) {  
		...
		let token = "{{ csrf_token() }}";
			let _url = `/project/toolstype/status`; 
			$.ajax({
				type: 'POST',  
				url: _url,
